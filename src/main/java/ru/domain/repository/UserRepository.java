...
public class UserRepository {
    ...
    public void saveUser(User user) {
        String sql = "INSERT INTO \"users-liquibase\" (name, email, password) VALUES (?, ?, ?) RETURNING id";
        try (Connection connection = DatabaseUtil.getConnection();
    ...
    public List<User> findAllUsers() {
        ...
        String sql = "SELECT id, name, email, password FROM \"users-liquibase\"";
        try (Connection connection = DatabaseUtil.getConnection();
    ...
    public Optional<User> findByUsername(String userName) throws SQLException {
        String sql = "SELECT id, name, email, password FROM \"users-liquibase\" WHERE name = ?";
        try (Connection connection = DatabaseUtil.getConnection();
            PreparedStatement statement = connection.prepareStatement(sql)) {
    ...
    public void updateUser(User user) {
        String sql = "UPDATE \"users-liquibase\" SET name = ?, email = ?, password = ? WHERE id = ?";
        try (Connection connection = DatabaseUtil.getConnection();
    ...
    public void deleteUser(int userId) {
        String sql = "DELETE FROM \"users-liquibase\" WHERE id = ?";
        try (Connection connection = DatabaseUtil.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
